...
#define UE_PROJECT_NAME InsectHeaven
#define UE_TARGET_NAME InsectHeavenEditor
#define UE_MODULE_NAME "InsectHeaven"
...
#define INSECTHEAVEN_API DLLEXPORT
